            ...
            <tbody className="divide-y divide-slate-800/80">
              {findings.length === 0 ? (
                ...
                findings.map((finding) => {
                  ...
                  return (
                    <tr key={repository.full_name} className="text-slate-300 hover:bg-slate-900/50">
                      <td className="px-5 py-4 font-medium text-slate-100">
                        <a className="hover:text-sky-300" href={repository.html_url} target="_blank" rel="noreferrer">
                          {repository.full_name}
                        </a>
                      </td>
                      <td className="px-5 py-4 text-slate-400">{owner}</td>
